...
import { Form, Input, Button, Card, Typography, Space, InputNumber, Divider, message, Spin } from 'antd';
  ...
  return (
    <>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
        <Title level={4} style={{ margin: 0 }}>Chỉnh Sửa: {product?.name}</Title>
                  ...
                  <div key={key} style={{ border: '1px solid rgba(255,255,255,0.08)', borderRadius: 10, padding: 16, marginBottom: 12, background: 'rgba(255,255,255,0.02)' }}>
                    ...
                    <div style={{ display: 'flex', gap: 16, alignItems: 'flex-start', flexWrap: 'wrap' }}>
                      ...
                      <Space wrap size={[16, 0]} style={{ flex: 1 }}>
                        ...
                        <Form.Item {...rest} label="Ngưỡng Cảnh Báo" name={[name, 'lowStockThreshold']} style={{ minWidth: 140 }}>
